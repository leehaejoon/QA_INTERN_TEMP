...
class test_register_user_01(unittest.TestCase):
    ...
    def setUp(self):
        if os.path.isfile(test_DB_file):  # 파일이 이미 존재하는 경우를 위한 예외처리
    ...
    def test_input_db(self):
        list_ = register_user_04.input_db(test_USER_ID, test_DB_file)
        self.assertEqual(list_[0][0],test_USER_ID)
